...
The motivation behind this project is to find underlying root causes and conditions for accidents and traffic violation. Once that is unveiled, I am hoping to make effective recommendations based on empirical findings that would lessen frequency of such traffic mishaps.
...
I will also be converting Yes/No observations to binary outputs, such as most of the observations in "Accident Details" subgroup.

This data set is massive. So a lot of wrangling will be required. I will be utilising dplyr's data manipulation functions to filter and mutate variables and observations. Some substitution will be required in order to streamline the data further.
